...
This repository now keeps the infrastructure automation under `infra/`.

- `infra/`: Ansible playbooks, roles, and scripts that configure the home server. Start by reading `infra/README.md`.
